...
from posts.views import GoogleLogin, ConvertTokenView, UserFeedView, UserProfileView, UploadPhotoView, FollowUserView

urlpatterns = [
    # -------------------- ROOT URL --------------------
    path('', lambda request: redirect('/admin/login/'), name='home'),  
    ...
    path('profile/follow/<int:user_id>/', FollowUserView.as_view(), name='profile-follow'),
]
